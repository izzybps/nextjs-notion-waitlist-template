...
interface FormProps {
  ...
  handleInstagramChange: (e: ChangeEvent<HTMLInputElement>) => void;
  handleSubmit: () => void;
  loading: boolean;
}
  ...
  return (
    <motion.div
      ...
      <motion.div
        ...
        <Link
          href="https://www.instagram.com/nilfmedia/"
          rel="noopener noreferrer"
          target="_blank">
          <FaInstagram className="ml-0.5 h-5 w-5 transition-all duration-200 ease-linear hover:text-red-200" />
        </Link>
        or
        <Link
